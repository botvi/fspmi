            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button type="button" class="btn btn-success" onclick="printRingkasanSaldo()">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div>
                                <button type="button" class="btn btn-info me-2" onclick="hitungUlangSaldo()">
                                    <i class="bx bx-calculator"></i> Hitung Ulang
                                </button>
                                <button type="button" class="btn btn-success" onclick="printDaftarMember()">
                                    <i class="bx bx-printer"></i> Print Daftar Member
                                </button>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered table-striped" id="table-member">
                                ...
                                <tbody>
                                    ...
                                    @forelse($member as $index => $m)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" 
                                                       class="form-control hutang-input" 
                                                       data-member-id="{{ $m->id }}"
                                                       placeholder="0" 
                                                       min="0" 
                                                       step="1000"
                                                       onchange="hitungSaldoAkhir(this)">
                                            </td>
                                ...
                                <tfoot class="table-info">
                                    <tr>
                                        ...
                                        <td class="text-end"><strong id="total-hutang">Rp 0</strong></td>
                                        <td class="text-end"><strong id="total-saldo-akhir">Rp {{ number_format($totalSaldo, 0, ',', '.') }}</strong></td>
                                    </tr>
                                    <tr>
