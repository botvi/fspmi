                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Edit Pengeluaran</h5>
                            </div>
                            <hr>
                            <form action="{{ route('pengeluaran.update', $pengeluaran->id) }}" method="POST"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_keluar" name="tanggal_keluar" required value="{{ old('tanggal_keluar', $pengeluaran->tanggal_keluar) }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea rows="3" type="text" class="form-control" id="keterangan" name="keterangan" required>{{ old('keterangan', $pengeluaran->keterangan) }}</textarea>
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" id="harga_satuan" name="harga_satuan"
                                        value="{{ old('harga_satuan', $pengeluaran->harga_satuan) }}" required
                                        oninput="hitungTotal()">
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" id="jumlah" name="jumlah"
                                        value="{{ old('jumlah', $pengeluaran->jumlah) }}" required oninput="hitungTotal()">
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="master_satuan_id" id="master_satuan_id" class="form-control">
                                        ...
                                        @foreach ($master_satuans as $ms)
                                            <option value="{{ $ms->id }}"
                                                {{ $pengeluaran->master_satuan_id == $ms->id ? 'selected' : '' }}>
                                                {{ $ms->nama_satuan }}</option>
                                        @endforeach
                                    </select>
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" id="total_harga" name="total_harga"
                                        value="{{ old('total_harga', $pengeluaran->total_harga) }}" readonly required>
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if ($pengeluaran->gambar)
                                        <div class="mb-2">
                                            <img src="{{ asset('uploads/pengeluaran/' . $pengeluaran->gambar) }}"
                                                alt="Gambar Pengeluaran" class="img-thumbnail" style="max-height: 200px">
                                        </div>
                                    @endif
